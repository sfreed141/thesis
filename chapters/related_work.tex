...
\missingfigure{Diagram of RSM? Or maybe contents of RSM if allowed to use paper's image (show my own)}
...
\missingfigure{Diagram of LPV and propogation? Can share figure with RVBDGI}
...
\missingfigure{Diagram of algorithm if allowed to use}
