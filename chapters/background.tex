...
% TODO basics, focus on rasterization, overview of shaders (especially compute shader), transforms
\subsection{Rasterization}
The ultimate goal of most graphics work is to produce a 2D image from some set of input data, typically a scene filled with triangle meshes and various light sources. The major steps to accomplish this are as follows:
\begin{description}
    \item[]
\end{description}
